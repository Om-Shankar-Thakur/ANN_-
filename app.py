...
def predict_crop(Nitrogen, Phosphorus, Potassium, Temperature, Humidity, ph, Rainfall):
    model = joblib.load(r'C:\Users\ANIMESH\Downloads\Crop-Recommendation-system--main\Crop-Recommendation-system--main\Crop recommendation system\crop_app\crop_app')
